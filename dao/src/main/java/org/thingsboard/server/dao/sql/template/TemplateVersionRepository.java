...
public interface TemplateVersionRepository extends JpaRepository<TemplateVersionEntity, UUID> {
    ...
    List<TemplateVersionEntity> findByTemplateIdOrderByCreatedTimeDesc(UUID templateId);

    Optional<TemplateVersionEntity> findByTemplateIdAndVersion(UUID templateId, String version);
